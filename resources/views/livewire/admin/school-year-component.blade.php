<div>
    @section('title', 'Admin / School Year')
    <!-- Main content header -->
    <div
        class="flex flex-col items-start justify-between pb-6 space-y-4 border-b lg:items-center lg:space-y-0 lg:flex-row">
        <h1 class="text-2xl font-semibold whitespace-nowrap">School Year</h1>
        @can('school-year-create')
        <a href="{{ route('admin.schoolyear.create') }}"
                    ...
                    <table class="min-w-full overflow-x-scroll divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="transition-all hover:bg-gray-100 ">
                                <td class="px-6 py-4">
                                    <div class="text-sm font-semibold text-gray-900">{{ $schoolYear->school_yr }}</div>
                                </td>
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    @can('school-year-edit')
                                    <x-link-success
                                        href="{{ route('admin.schoolyear.edit', ['school_year_id' => $schoolYear->id]) }}"> Edit
                                    </x-link-success>
                                    @endcan
                                    ...
                                    <x-link-danger href="" class="btn btn-danger btn-sm text-light"
                                        ...
                                        wire:click.prevent="destroy({{ $schoolYear->id }})">
                                        Delete
                                    </x-link-danger>
                                    @endcan
                                </td>
                            ...
                            <tr class="transition-all hover:bg-gray-100 hover:shadow-lg">
                                <td class="px-6 py-4 text-center whitespace-nowrap" colspan="3">
                                    <div class="text-sm font-medium text-gray-900">No School Year Found!</div>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
