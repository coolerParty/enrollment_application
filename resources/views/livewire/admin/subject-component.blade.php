<div>
    ...
    <div
        ...
        <h1 class="text-2xl font-semibold whitespace-nowrap">Subject</h1>
        @can('subject-create')
                    ...
                    <table class="min-w-full overflow-x-scroll divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="transition-all hover:bg-gray-100 ">
                                <td class="px-6 py-4">
                                    <div class="text-sm font-semibold text-gray-900">{{ $subject->sub_code }}</div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm font-semibold text-gray-900">{{ $subject->sub_name }}</div>
                                </td>
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    @can('subject-edit')
                                    <x-link-success
                                        href="{{ route('admin.subject.edit', ['subject_id' => $subject->id]) }}"> Edit
                                    </x-link-success>
                                    @endcan
                                    @can('subject-delete')
                                    <x-link-danger href="" class="btn btn-danger btn-sm text-light"
                                        ...
                                        wire:click.prevent="destroy({{ $subject->id }})">
                                        Delete
                                    </x-link-danger>
                                    @endcan
                                </td>
                            ...
                            <tr class="transition-all hover:bg-gray-100 hover:shadow-lg">
                                <td class="px-6 py-4 text-center whitespace-nowrap" colspan="3">
                                    <div class="text-sm font-medium text-gray-900">No Subject Found!</div>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
