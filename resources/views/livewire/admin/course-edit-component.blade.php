<div>
    ...
    <div
        ...
        <h1 class="text-lg font-semibold whitespace-nowrap">Course <span class="text-base text-gray-400">/</span> {{
            $course_name }} <span class="text-base text-gray-400">/</span> <span class="text-2xl">Create</span></h1>
