<div>
    ...
    <div
        ...
        <h1 class="text-lg font-semibold whitespace-nowrap">School Year <span class="text-base text-gray-400">/</span> {{
            $school_yr }} <span class="text-base text-gray-400">/</span> <span class="text-2xl">Create</span></h1>
    ...
    <div class="max-w-full md:bg-gray-300 md:p-4">
        ...
        <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
            ...
            <form wire:submit.prevent="update">
                <div class="mt-4">
                    <div>
                        <label class="text-gray-700 dark:text-gray-200" for="school_yr">School Year</label>
                        <input id="school_yr" type="number" name="school_yr" value="{{ old('school_yr') }}" wire:model.lazy="school_yr" required
                            autofocus autocomplete="school_yr"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring
                            @error('school_yr') border-red-500 @enderror">
                            @error('school_yr')<p class="text-xs italic text-red-500">{{ $message }}</p>@enderror
                    </div>
                </div>
