<div>
    ...
    <div
        ...
        <h1 class="text-lg font-semibold whitespace-nowrap">Subject <span class="text-base text-gray-400">/</span> <span
    ...
    <div class="max-w-full md:bg-gray-300 md:p-4">
        ...
        <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
            ...
            <form wire:submit.prevent="store">
                <div class="mt-4">
                    <div>
                        <label class="text-gray-700 dark:text-gray-200" for="sub_code">Subject Code</label>
                ...
                <div class="mt-4">
                    <div>
                        <label class="text-gray-700 dark:text-gray-200" for="subject_name">Subject Name</label>
                        <input id="subject_name" type="text" name="subject_name" value="{{ old('subject_name') }}"
                            wire:model.lazy="subject_name" required autofocus autocomplete="subject_name"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring
                            @error('subject_name') border-red-500 @enderror">
                            @error('subject_name')<p class="text-xs italic text-red-500">{{ $message }}</p>@enderror
                    </div>
                </div>
