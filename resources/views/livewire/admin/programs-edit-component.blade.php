<div>
    ...
    <div
        ...
        <h1 class="text-lg font-semibold whitespace-nowrap">Programs <span class="text-base text-gray-400">/</span> {{
            $schoolYear }} <span class="text-base text-gray-400">/</span> <span class="text-2xl">Edit</span></h1>
